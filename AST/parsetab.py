...
_lr_action_items = {'NUMBER': ([0, 3, 5, 6, 7, 8, 9, ], [2, 2, 2, 2, 2, 2, 2, ]),
                    'LPAREN': ([0, 3, 5, 6, 7, 8, 9, ], [3, 3, 3, 3, 3, 3, 3, ]),
                    'IDENTIFIER': ([0, 3, 5, 6, 7, 8, 9, ], [4, 4, 4, 4, 4, 4, 4, ]),
                    '$end': ([1, 2, 4, 11, 12, 13, 14, 15, 16, ], [0, -6, -8, -1, -2, -3, -4, -5, -7, ]),
                    'PLUS': ([1, 2, 4, 10, 11, 12, 13, 14, 15, 16, ], [5, -6, -8, 5, -1, -2, -3, -4, -5, -7, ]),
                    'MINUS': ([1, 2, 4, 10, 11, 12, 13, 14, 15, 16, ], [6, -6, -8, 6, -1, -2, -3, -4, -5, -7, ]),
                    'TIMES': ([1, 2, 4, 10, 11, 12, 13, 14, 15, 16, ], [7, -6, -8, 7, 7, 7, -3, -4, -5, -7, ]),
                    'DIVIDE': ([1, 2, 4, 10, 11, 12, 13, 14, 15, 16, ], [8, -6, -8, 8, 8, 8, -3, -4, -5, -7, ]),
                    'EXPONENT': ([1, 2, 4, 10, 11, 12, 13, 14, 15, 16, ], [9, -6, -8, 9, 9, 9, 9, 9, 9, -7, ]),
                    'RPAREN': ([2, 4, 10, 11, 12, 13, 14, 15, 16, ], [-6, -8, 16, -1, -2, -3, -4, -5, -7, ]), }
